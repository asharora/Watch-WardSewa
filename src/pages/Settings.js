...
import { faBoxOpen, faCartArrowDown, faChartPie, faChevronDown, faClipboard, faFileAlt, faPlus, faRocket, faStore } from '@fortawesome/free-solid-svg-icons';
...
export default () => {
  ...
  return (
    ...
    <RankingTable />
      ...
      <Dropdown.Toggle as={Button} variant="secondary" className="text-dark me-2" onClick={()=>{setnewDuties(!newDuties);}}>
